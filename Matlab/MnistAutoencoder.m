...
classdef MnistAutoencoder < handle
    ...
    methods(Static)
        ...
        function RunExperiments()
            ...
            % Define a compact function to launch an experiment
            function Go(iEpochs, bSample, bDropout, iaSize)
            ...
            % Load the mnist data
            load('Mnist','raaTrain','raaTest');
            
            % Measure the training data
            [iSamples, iFeatures] = size(raaTrain);
        ...
        function RbmExperiment(raaTrain, raaTest, iaSize, iEpochs, bSample, raDropV, raDropH)
                                              
            % Create momentum schedule
            raMomentum = 0.9*ones(iEpochs,1);
            raMomentum(1:5) = 0.5;
            ...
            function Report(iLayer, iEpoch, bSample, rDropV, rDropH, rRate, rMomentum, rRmse, rError)
        ...
        function ViewFeatureDetectors(sModel)
